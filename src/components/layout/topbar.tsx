    ...
    return (
        <div className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4 md:px-8 sticky top-0 z-10 shadow-sm">
            <div className="flex items-center space-x-4">
                ...
                {/* Search Bar - Hidden or collapsed on small screens if needed, but keeping for now */}
            ...
            <div className="flex items-center space-x-3 md:space-x-6">
                {/* System Status Label - Hidden on mobile */}
                <Badge className="hidden md:flex bg-green-50 text-green-700 hover:bg-green-100 border-none px-3 py-1 items-center space-x-1.5 font-bold text-[11px] uppercase tracking-wide rounded-[4px]">
