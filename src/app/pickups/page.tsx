            ...
            <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
                ...
                <main className="flex-1 overflow-y-auto p-8 space-y-6">
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-2xl font-bold text-[#1A1A1A] tracking-tight leading-tight">Pickup Management</h1>
                            <p className="text-sm text-[#636E72] font-semibold mt-1">5 total pickups today</p>
                        </div>
                        <LiveStatus />
                    </div>
                    ...
                    <div className="flex items-center space-x-4">
                        <div className="relative flex-[4]">
                            ...
                            <Input
                                placeholder="Search by pickup ID or user..."
                                value={searchQuery}
